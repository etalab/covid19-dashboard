...
export function getFeatureTerritoire(feature) {
  let [typeTerritoire, codeTerritoire] = feature.properties.code.split('-')

  if (!codeTerritoire) { // Deal with code without territory type prefix
    codeTerritoire = typeTerritoire
    typeTerritoire = feature.properties.region ? 'DEP' : 'REG'
  }

  return [typeTerritoire, codeTerritoire]
}
